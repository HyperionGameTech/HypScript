...
class FlatMap : public SortedArray<KeyValuePair<Key, Value>, AllocatorType>
{
public:
...
public:
    ...
    using Base = SortedArray<KeyValuePair<Key, Value>, AllocatorType>;
    ...
    HYP_NODISCARD FlatSet<Key, AllocatorType> Keys() const;
    HYP_NODISCARD FlatSet<Value, AllocatorType> Values() const;
...
FlatMap<Key, Value, AllocatorType>::FlatMap()
{
}

template <class Key, class Value, class AllocatorType>
FlatMap<Key, Value, AllocatorType>::FlatMap(const FlatMap& other)
    : Base(static_cast<const Base&>(other))
{
}

template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::operator=(const FlatMap& other) -> FlatMap&
{
...
template <class Key, class Value, class AllocatorType>
FlatMap<Key, Value, AllocatorType>::FlatMap(FlatMap&& other) noexcept
    : Base(std::move(static_cast<Base&&>(other)))
{
}

template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::operator=(FlatMap&& other) noexcept -> FlatMap&
{
...
template <class Key, class Value, class AllocatorType>
FlatMap<Key, Value, AllocatorType>::~FlatMap() = default;

template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::Find(const Key& key) -> Iterator
{
    const auto it = Base::LowerBound(key);
...
template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::Find(const Key& key) const -> ConstIterator
{
    const auto it = Base::LowerBound(key);
...
template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::Insert_Internal(KeyValuePair<Key, Value>&& pair) -> InsertResult
{
...
template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::Insert(const Key& key, const Value& value) -> InsertResult
{
    return Insert_Internal(KeyValuePair<Key, Value> { key, value });
}

template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::Insert(const Key& key, Value&& value) -> InsertResult
{
    return Insert_Internal(KeyValuePair<Key, Value> { key, std::move(value) });
}

template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::Insert(const Pair<Key, Value>& pair) -> InsertResult
{
    return Insert_Internal(KeyValuePair<Key, Value>(pair));
}

template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::Insert(Pair<Key, Value>&& pair) -> InsertResult
{
    return Insert_Internal(std::move(pair));
}

template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::Set_Internal(KeyValuePair<Key, Value>&& pair) -> InsertResult
{
    const auto lowerBound = Base::LowerBound(pair.first);
...
template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::Set(const Key& key, const Value& value) -> InsertResult
{
    return Set_Internal(KeyValuePair<Key, Value> { key, value });
}

template <class Key, class Value, class AllocatorType>
auto FlatMap<Key, Value, AllocatorType>::Set(const Key& key, Value&& value) -> InsertResult
{
...
template <class Key, class Value, class AllocatorType>
bool FlatMap<Key, Value, AllocatorType>::Erase(const Key& value)
{
    return Erase(Find(value));
}

template <class Key, class Value, class AllocatorType>
FlatSet<Key, AllocatorType> FlatMap<Key, Value, AllocatorType>::Keys() const
{
    FlatSet<Key, AllocatorType> keys;
    keys.Reserve(Size());
...
template <class Key, class Value, class AllocatorType>
FlatSet<Value, AllocatorType> FlatMap<Key, Value, AllocatorType>::Values() const
{
    FlatSet<Value, AllocatorType> values;
    values.Reserve(Size());
...
template <class Key, class Value, class AllocatorType>
struct IsFlatMap<FlatMap<Key, Value, AllocatorType>> : std::true_type
{
};
