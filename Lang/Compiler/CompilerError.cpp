...
const Map<ErrorMessage, String> CompilerError::errorMessageStrings {
    ...
    { Msg_case_outside_switch, "'case' outside of a switch statement" },
    { Msg_duplicate_default, "Duplicate 'default' in switch statement" },
    { Msg_switch_case_requires_constant, "Case expression must resolve to a constant value" },
    { Msg_switch_duplicate_case, "Duplicate case value in switch statement" },
